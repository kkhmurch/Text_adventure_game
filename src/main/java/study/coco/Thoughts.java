...
public class Thoughts {
    ...
    public static String thought3 = """
            ...
            + Ansi.ansi().a(ITALIC).a("(take/leave + full name of the item)").reset();
    public static String thought4 = "STOP! This is a human history!"+ Ansi.ansi().a(ITALIC).a("(take/leave item)").reset();
    ...
    public static  String thought10 = """
